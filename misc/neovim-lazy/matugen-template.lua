...
local function make_palette(mode)
  ...
  return {
    ...
    -- ramp runs darker with elevation in light and lighter in dark. NOTE: if
    -- the header looks muddy, bump nc/tab_bg one rung to
...
local function build(p, transparent)
  ...
  -- Border/Title/Footer default-link down to FloatBorder/FloatTitle/FloatFooter
  -- (elevated `fl`), so they need their own override too or a mismatched ring
  -- of the old elevated tone shows around the now-flush window body.
