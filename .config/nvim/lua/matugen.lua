...
M.material = {
  dark = {
    surface                   = '#1d100d',
    surface_dim               = '#1d100d',
    surface_bright            = '#463532',
    surface_container_lowest  = '#180b08',
    surface_container_low     = '#261815',
    surface_container         = '#2b1c19',
    surface_container_high    = '#362623',
    surface_container_highest = '#42312e',
    on_surface                = '#f8ddd7',
    on_surface_variant        = '#e2beb8',
    outline                   = '#a98983',
    outline_variant           = '#5a413c',
    primary                   = '#ffb4a6',
    on_primary                = '#650900',
    primary_container         = '#ca3a22',
    secondary                 = '#ffb4a6',
    on_secondary              = '#5c190d',
    secondary_container       = '#7d3123',
    tertiary                  = '#f3be5a',
    on_tertiary               = '#422d00',
    tertiary_container        = '#916700',
    error                     = '#ffb4ab',
    on_error                  = '#690005',
    inverse_surface           = '#f8ddd7',
    inverse_on_surface        = '#3d2c29',
    inverse_primary           = '#b32913',
    term = {
      black   = '#5a413c',
      red     = '#ffb4ab',
      green   = '#ffb4a6',
      ...
      bright_red     = '#ffb4ab',
      bright_green   = '#ffb4a6',
      bright_yellow  = '#ffb4a6',
      bright_blue    = '#f3be5a',
      bright_magenta = '#ffb4a6',
      bright_cyan    = '#ffb4a6',
      bright_white   = '#f8ddd7',
      bg          = '#1d100d',
      fg          = '#f8ddd7',
  ...
  light = {
    ...
    surface_container_low     = '#fff0ee',
    surface_container         = '#ffe9e5',
    surface_container_high    = '#fee2dd',
    surface_container_highest = '#f8ddd7',
    on_surface                = '#261815',
    on_surface_variant        = '#5a413c',
    outline                   = '#8e706a',
    outline_variant           = '#e2beb8',
    primary                   = '#a7210b',
    on_primary                = '#ffffff',
    primary_container         = '#ca3a22',
    secondary                 = '#984536',
    on_secondary              = '#ffffff',
    secondary_container       = '#ff9783',
    tertiary                  = '#725000',
    on_tertiary               = '#ffffff',
    tertiary_container        = '#916700',
    error                     = '#ba1a1a',
    on_error                  = '#ffffff',
    inverse_surface           = '#3d2c29',
    inverse_on_surface        = '#ffede9',
    inverse_primary           = '#ffb4a6',
    term = {
      black   = '#ffdad3',
      red     = '#ba1a1a',
      green   = '#a7210b',
      ...
      bright_red     = '#ba1a1a',
      bright_green   = '#a7210b',
      bright_yellow  = '#984536',
      bright_blue    = '#725000',
      bright_magenta = '#a56156',
      bright_cyan    = '#a56156',
      bright_white   = '#261815',
      bg          = '#fff8f6',
      fg          = '#261815',
...
M.noctalia_mode = ('#1d100d' == '#fff8f6') and 'light' or 'dark'
